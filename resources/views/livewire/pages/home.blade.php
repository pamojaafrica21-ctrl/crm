...
<div class="overflow-x-hidden">
    ...
    <section class="border-y border-[var(--line)] bg-[var(--mist)]">
        <div class="mx-auto max-w-6xl px-6 py-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-[var(--ink-soft)]/80 max-w-md">Create your organisation and explore the full CRM — customers, quotes, invoices, reports, and day-to-day operations for any industry. No card required to start.</p>
            </div>
    ...
    <section id="product" class="mx-auto max-w-6xl px-6 py-20 sm:py-28 space-y-28">
        <div class="max-w-2xl">
            <h2 class="font-display text-4xl sm:text-5xl leading-tight text-[var(--ink)]">One CRM built for every industry</h2>
            <p class="mt-4 text-lg text-[var(--ink-soft)]/75 leading-relaxed">Customer relationship management, sales quotes, invoices, staff tasks, and detailed reporting — for teams across industries, organised by location.</p>
        </div>
    ...
    <section class="mx-auto max-w-6xl px-6 pb-20 sm:pb-28">
        <div class="relative overflow-hidden rounded-[1.75rem] px-8 py-14 sm:px-14 sm:py-16 text-white"
            ...
            <p class="mt-4 max-w-lg text-white/70 text-lg">
                Spin up {{ $appName }} in minutes and run your business operations on a {{ $trialDays }}-day free trial.
            </p>
    ...
    <footer class="border-t border-[var(--line)] bg-[var(--mist)]/40">
        <div class="mx-auto max-w-6xl px-6 py-14 sm:py-16">
            <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                <div class="lg:col-span-1">
                    ...
                    <p class="mt-4 text-sm leading-relaxed text-[var(--ink-soft)]/75 max-w-xs">
                        CRM software for every industry — customers, quotes, invoices, appointments, reports, and operations in one place.
                    </p>
                </div>
            ...
            <div class="mt-12 pt-8 border-t border-[var(--line)] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-xs text-[var(--ink-soft)]/55">
                ...
                <p>CRM for every industry · Sales &amp; billing · Team operations SaaS</p>
            </div>
        </div>
    </footer>
</div>
